...
description: Use for code reviews, audits, bug hunts, CI regression diagnosis, security/correctness investigations, state mutation checks, contract changes, async/concurrency risk, persistence/cache consistency, paired operation parity, and explicit requests such as audit, review, nemesis, Feynman, state audit, or regression analysis.
---
